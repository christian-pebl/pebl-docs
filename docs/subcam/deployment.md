...
description: Siting, aiming and settings for good footage, with a pre-deployment checklist and recovery steps.
sidebar_position: 7.5
---

# Field deployment

This guide is about getting good footage from the SubCam in the field: choosing a site, aiming the camera, picking settings for the conditions, and what to check before and after every deployment. For the mechanics of mounting and rigging, see [Mounting](./mounting.md) and the [Mooring Guide](../mooring-guide/index.md).
...
* [Low exposure](../mooring-guide/frame-configurations/low-exposure.md): around 5 m, calm, slow current.
* [Med exposure](../mooring-guide/frame-configurations/med-exposure.md): around 10 m, moderate.
* [High exposure](../mooring-guide/frame-configurations/high-exposure.md): around 20 m, exposed, strong current.

Under-rigging for the conditions is a common way to lose a deployment, so if you are between levels, go up one.

## Aim the camera

* **Tilt.** A downward tilt of about **15 degrees** is a good starting point for seabed scenes. See [Camera Configuration](../mooring-guide/camera-configuration.md) for how tilt, field of view and reach relate.
...
See [Configure](../pebl-app/configure.md) and [Schedule](../pebl-app/schedule.md) in the PEBL App guide for these settings.
...
* Copy your data and media off the device (see [Operating and retrieving data](./operating.md)).
* Follow [Maintenance](./maintenance.md) for drying and storage.
